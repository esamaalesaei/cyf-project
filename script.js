var cars_images, purchase_quantity, cars_names, cars_prices, items_in_cart, cars_desc, total_purchases;
...
cars_images = ['https://cdn.pixabay.com/photo/2017/04/06/22/11/car-2209439_960_720.png', 'https://www.topgear.com/sites/default/files/cars-car/image/2019/04/toyota-camry-hybrid-exterior-dynamic-not-uk-spec-26.jpg', 'https://cdn.motor1.com/images/mgl/3WW1j1/s3/2022-bmw-i7.jpg'];
cars_names = ['Bogati', 'Camry', 'BMW'];
cars_prices = [100000, 20000, 50000];
cars_desc = ['This is the fastest car in the world, you would be lucky if you buy it', 'This is a budget car with exceptional performance', 'This is the best of the German cars'];
purchase_quantity = 0;
items_in_cart = [];
total_purchases = [];
...
document.getElementById('purchase-order').addEventListener('click', (event) => {
  purchase_quantity = (typeof purchase_quantity === 'number' ? purchase_quantity : 0) + 1;
...
document.getElementById('post-comment').addEventListener('click', (event) => {
  ...
  new_span2.innerText = getNumberOrString(document.getElementById('user-comment').value);
